...
func (driver *driver) requestAddress(w http.ResponseWriter, r *http.Request) {
	...
	ipam, err := driver.client.IPAMAllocate(family, "docker-ipam", client.PoolPodCIDR, false)
	if err != nil {
...
func (driver *driver) releaseAddress(w http.ResponseWriter, r *http.Request) {
	...
	if err := driver.client.IPAMReleaseIP(release.Address, client.PoolPodCIDR); err != nil {
